...
public class ExchangeHandler implements IFeatureHandler {
	private static FeatureSetInfo _featureSet;
	
	public ExchangeHandler(int featureSetId) {
		_featureSet = new FeatureSetInfo(featureSetId,"ExchangeFeature");
	}
	...
	public Vector<Feature> ExtractFeature(DataInstance dataInst) {
		...
		long localId = NumericalUtil.getLocalId(_featureSet.GetFeatureSetId(), "" + rtbInst.getAdExchange());
